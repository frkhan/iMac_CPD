	...
	class login_widget_admin_security {
		...
		public function security_add(){
			...
			<p>
				...
				'.form_class::form_input('text','admin_captcha','admin_captcha','','input','','','','20','',true,'','',false,__('Please enter captcha','login-sidebar-widget')).'
			</p>';
		}
		...
		public function security_add_user(){
			echo '<div class="log-form-group">
				...
				'.form_class::form_input('text','user_captcha','user_captcha','','','','','','','',true,__('Security code','login-sidebar-widget'),'',false,__('Please enter captcha','login-sidebar-widget')).'
			</div>';
		}
	}
}
